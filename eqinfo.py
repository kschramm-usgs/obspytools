...
from obspy.core.event import read_events as readEvents
...
stimeString = ('starttime=' + 
              (stime.format_iris_web_service()).replace('T','%20'))
etimeString = ('endtime=' + 
              (etime.format_iris_web_service()).replace('T','%20'))

# this is for older versions of obspy which still exist on some systems at ASL
